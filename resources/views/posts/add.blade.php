...
<div class="row">
    <div class="col-12">
        <div class="card">
            {!! Form::open(array('url' => url('post'), 'method' => 'post', 'class' => 'bf', 'files'=> true)) !!}
                <div class="card-body">
                    <h4 class="card-title">Бичлэг нэмэх <a href="{{ url('/post') }}"><button type="button" class="btn btn-primary jd-back-btn">Буцах</button></a></h4>
                    <div id="success"></div>
                    <br />
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                        {!! Form::label('title', 'Гарчиг:', array('class' => 'control-label jd-bold')) !!}
                        <div class="controls">
                            {!! Form::text('title', null, array('class' => 'form-control')) !!}
                            <span class="help-block text-danger">{{ $errors->first('title', ':message') }}</span>
                        </div>
                    </div>
                    <div class="form-group {{ $errors->has('content') ? 'has-error' : '' }}">
                        <div class="controls">
                            {!! Form::textarea('content', null, array('class' => 'form-control', 'id' => 'content' )) !!}
                            <span class="help-block text-danger">{{ $errors->first('content', ':message') }}</span>
                        </div>
                    </div>
